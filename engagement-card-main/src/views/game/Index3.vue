  ...
  <div class="game-warp" v-loading="loading">
    <div class="game-box row">
      ...
      >
        ...
        <div class="user-cards-box column column-center">
          ...
          <!-- <div class="card-box" v-if="!info.isPublic && mode != 'watch'" v-for="(item, index) in user2.cards" :data-id="item.id">
            <div class="card-box2 column column-center row-center" style="transform: rotate(90deg)">
              <el-image class="card" :src="cardsBack" fit="contain" style="transform: rotate(0deg);">
              </el-image>
            </div>
          </div> -->
        </div>
      ...
      >
        ...
        <div class="user-cards-box column column-center" style="flex-direction: column-reverse;">
          ...
          <!-- <div class="card-box" v-if="!info.isPublic && mode != 'watch'" v-for="(item, index) in user3.cards"
            :data-id="item.id" >
            <div class="card-box2 column column-center row-center" style="transform: rotate(90deg);">
    ...
    <div class="game-user-self row">
      ...
      <div class="room-info row-flex column column-center">
        ...
        <div class="item countdown" style="margin-top: 8px">
          <div class="counts">{{ userTimes }}<span>s</span></div>
          <div class="txt">時間</div>
        </div>
        <div class="item times" style="margin-top: 8px">
          <div class="counts">{{ gameTimes.str }}</div>
          <div class="txt">トータル時間</div>
        </div>
        <div class="item peopleNumber" style="margin-top: 8px">
