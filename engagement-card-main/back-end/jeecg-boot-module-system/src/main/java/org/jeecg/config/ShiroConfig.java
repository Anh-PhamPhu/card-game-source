...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/parperless_office/**","anon");
		...
		filterChainDefinitionMap.put("/oauth/**", "anon"); //第三方登录
		...
		filterChainDefinitionMap.put("/sys/user/changePassword", "anon");//用户忘记密码
