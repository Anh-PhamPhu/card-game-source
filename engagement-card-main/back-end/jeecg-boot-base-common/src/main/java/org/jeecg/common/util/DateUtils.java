...
public class DateUtils extends PropertyEditorSupport {
    ...
    public static ThreadLocal<SimpleDateFormat> dayFormat = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
    ...
    public static String getYear(Date date) {
        return yearFormat.get().format(date);
    }
    ...
    public static String longtoStr(Long time) {
        return date_sdf.get().format(new Date(time * 1000L));
    }
